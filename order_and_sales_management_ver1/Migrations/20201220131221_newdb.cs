    ...
    public partial class newdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableBarcodes", x => x.barcodeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    barcodeID = table.Column<string>(maxLength: 13, nullable: false),
                    productKDV = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_baseProducts", x => x.baseId);
                    table.UniqueConstraint("AK_baseProducts_barcodeID", x => x.barcodeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    productBarcodeID = table.Column<string>(maxLength: 13, nullable: false),
                    ...
                    productDuration = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_labelmodels", x => x.productBarcodeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    packedProductBarcodeID = table.Column<string>(maxLength: 13, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_packedProducts_packedProductBarcodeID", x => x.packedProductBarcodeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeraziScreenMapping", x => new { x.teraziID, x.barcodeID });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    baseProductBarcodeID = table.Column<string>(maxLength: 13, nullable: true),
                    packedProductBarcodeID = table.Column<string>(maxLength: 13, nullable: false),
                    baseId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_packedProductDetails_packedProductBarcodeID_contentLineNo", x => new { x.packedProductBarcodeID, x.contentLineNo });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    personelID = table.Column<int>(nullable: false),
                    change5KRS = table.Column<int>(nullable: false),
                    ...
                    nakit5KRS = table.Column<int>(nullable: false),
